...
-- 表数据: admin
INSERT INTO admin VALUES ('1', 'admin', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', 'admin', '2026-05-15 00:11:09');
...
CREATE TABLE `system_log` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统日志表';

-- 表数据: system_log
INSERT INTO system_log VALUES ('1', 'admin', '登录', '管理员 [admin] 通过Web端登录系统，角色：admin', '2026-05-15 00:11:56');
INSERT INTO system_log VALUES ('2', 'admin', '登录', '管理员 [admin] 通过Web端登录系统，角色：admin', '2026-05-15 00:12:58');
INSERT INTO system_log VALUES ('3', 'admin', '登出', '管理员 [admin] 退出登录', '2026-05-15 00:13:00');
INSERT INTO system_log VALUES ('4', 'admin', '登录', '管理员 [admin] 通过Web端登录系统，角色：admin', '2026-05-15 00:16:46');
INSERT INTO system_log VALUES ('5', 'admin', '登录', '管理员 [admin] 通过Web端登录系统，角色：admin', '2026-05-15 00:18:26');
INSERT INTO system_log VALUES ('6', 'admin', '登录', '管理员 [admin] 通过Web端登录系统，角色：admin', '2026-05-15 00:59:10');
...
-- 表数据: user
INSERT INTO user VALUES ('1', 'test001', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '张三', '110101199001011234', '13800138001', '100.00', '1', '100', '1', '2026-05-15 00:11:09');
INSERT INTO user VALUES ('2', 'test002', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '李四', '110101199002021235', '13800138002', '200.00', '2', '500', '1', '2026-05-15 00:11:09');
INSERT INTO user VALUES ('3', 'test003', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '王五', '110101199003031236', '13800138003', '50.00', '1', '50', '1', '2026-05-15 00:11:09');
